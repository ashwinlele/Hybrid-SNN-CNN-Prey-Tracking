                ...
                if cfg.mode == 'infer':
                    for drone in range(cfg.num_agents):
                        ...
                        if name_agent == "drone1":
                            ...
                            vertical = 0 + 10*v_fv #100*(abs(vz)+0.003)*one_array
                            horizontal = 60*abs(yaw_speed)*one_array  + 20*v_fh # + 1000*0.8*v_sideward*one_array
                            ...
                            print('snn detection', drone_x, drone_y)
                            found_snn = 0
                            found_snn_act = 0
                            ...
                            if area < 9000:
                                frequency = 5 ## put twice the vlue that is needed
                            else:
                                frequency = 10 
