                ...
                if cfg.mode == 'infer':
                    for drone in range(cfg.num_agents):
                        ...
                        if name_agent == "drone1":
                            ...
                            Vel[iter,:] = [iter, found_snn, found, suspect, snn_time,  valid_drone_x, valid_drone_y, area, yaw_speed, v_up, v_forward,x_val0,y_val0,z_val0,x_val1,y_val1,z_val1,snn_position[0],snn_position[1],yaw_prev,snn_accuracy,gt_x,gt_y,time.time()-iteration_begin_time,prey_speed[0],prey_speed[1]]
